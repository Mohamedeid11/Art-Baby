                                    ...
                                    @if(count($categories) > 0)
                                        ...
                                        <tr class="gradeX {{ $category['id'] }}">
                                            ...
                                            <td style="text-align:center;">
                                                ...
                                                <input class="off cm-toggle" data-id="{{ $category['id'] }}" type="checkbox" id="toggle" checked />
                                                @else
                                                <input class="on cm-toggle cm-toggle" data-id="{{ $category['id'] }}" type="checkbox" id="toggle"/>
                                                @endif
                                            </td>
                                            <td>

                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">@lang('dashboard.addClient')</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form method="POST" action="{{ route('clients.store') }}" data-parsley-validate novalidate>
                                    @csrf
                                    <div class="form-group col-md-6">
                                        <label for="first_name">@lang('dashboard.first_name')</label>
                                        <input id="first_name" type="text" name="first_name" required placeholder="@lang('dashboard.first_name')" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="last_name">@lang('dashboard.last_name')</label>
                                        <input id="last_name" type="text" name="last_name" required placeholder="@lang('dashboard.last_name')" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="email" type="email" name="email" required placeholder="@lang('dashboard.email')" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">

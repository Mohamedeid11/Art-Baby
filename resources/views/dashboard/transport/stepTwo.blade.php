                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form method="POST" action="{{ route('transport.send') }}" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="p_name" type="text" name="p_name" required placeholder="@lang('dashboard.p_name')" class="form-control" value="{{ $request['p_name'] }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="p_phone">@lang('dashboard.p_phone')</label>
                                        <input id="p_phone" type="text" name="p_phone" required placeholder="@lang('dashboard.p_phone')" class="form-control" value="{{ $request['p_phone'] }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="p_building">@lang('dashboard.p_building')</label>
                                        <input id="p_building" type="text" name="p_building" required placeholder="@lang('dashboard.p_building')" class="form-control" value="{{ $request['p_building'] }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="p_road_no">@lang('dashboard.p_road_no')</label>
                                        <input id="p_road_no" type="text" name="p_road_no" required placeholder="@lang('dashboard.p_road_no')" class="form-control" value="{{ $request['p_road_no'] }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="p_block_no">@lang('dashboard.p_block_no')</label>
                                        <input id="p_block_no" type="text" name="p_block_no" required placeholder="@lang('dashboard.p_block_no')" class="form-control" value="{{ $request['p_block_no'] }}">
                                    </div>
                                    <div class="col-12 col-md-12">
                                        <div class="form-group col-md-6">
                                            <label for="from_lat">@lang('dashboard.from_lat')</label>
                                            <input id="from_lat" type="text" name="from_lat" required placeholder="@lang('dashboard.from_lat')" class="form-control" value="{{ $request['from_lat'] }}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="from_lng">@lang('dashboard.from_lng')</label>
                                            <input id="from_lng" type="text" name="from_lng" required placeholder="@lang('dashboard.from_lng')" class="form-control" value="{{ $request['from_lng'] }}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="p_location">@lang('dashboard.p_location')</label>
                                            <input id="p_location" type="text" name="p_location" required placeholder="@lang('dashboard.p_location')" class="form-control" value="{{ $request['p_location'] }}">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>

                                    <h3>@lang('dashboard.clientInfo')</h3>

                                    <div class="form-group col-md-6">
                                        <label for="d_name">@lang('dashboard.d_name')</label>
                                        <input id="d_name" type="text" name="d_name" required placeholder="@lang('dashboard.d_name')" class="form-control" value="{{ $order->client['first_name'] }} {{ $order->client['first_name'] }}">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="d_phone">@lang('dashboard.d_phone')</label>
                                        <input id="d_phone" type="text" name="d_phone" required placeholder="@lang('dashboard.d_phone')" class="form-control" value="{{ $order->client['phone'] }}">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="d_building">@lang('dashboard.d_building')</label>
                                        <input id="d_building" type="text" name="d_building" required placeholder="@lang('dashboard.d_building')" class="form-control">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="d_road_no">@lang('dashboard.d_road_no')</label>
                                        <input id="d_road_no" type="text" name="d_road_no" required placeholder="@lang('dashboard.d_road_no')" class="form-control">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="d_block_no">@lang('dashboard.d_block_no')</label>
                                        <input id="d_block_no" type="text" name="d_block_no" required placeholder="@lang('dashboard.d_block_no')" class="form-control">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="to_lat">@lang('dashboard.to_lat')</label>
                                            <input id="to_lat" type="text" name="to_lat" required placeholder="@lang('dashboard.to_lat')" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="to_lng">@lang('dashboard.to_lng')</label>
                                            <input id="to_lng" type="text" name="to_lng" required placeholder="@lang('dashboard.to_lng')" class="form-control">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="d_location">@lang('dashboard.d_location')</label>
                                            <input id="d_location" type="text" name="d_location" required placeholder="@lang('dashboard.d_location')" class="form-control">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group text-right m-b-0">
                                        <button class="btn btn-primary waves-effect waves-light" type="submit" name="submit">@lang('dashboard.send')</button>

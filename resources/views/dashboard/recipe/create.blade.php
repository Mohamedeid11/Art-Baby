                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form method="POST" action="{{ route('recipes.store') }}" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    @csrf
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="link" type="text" name="link" required placeholder="@lang('dashboard.link')" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">

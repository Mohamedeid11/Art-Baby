                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">@lang('dashboard.addCurrency')</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form method="POST" action="{{ route('currencies.store') }}" data-parsley-validate novalidate>
                                    @csrf
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="value" type="text" name="value" required placeholder="@lang('dashboard.value')" class="form-control">
                                    </div>
                                    <div class="form-group col-md-6">

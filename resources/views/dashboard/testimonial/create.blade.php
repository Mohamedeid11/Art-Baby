                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">@lang('dashboard.addTestimonial')</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form method="POST" action="{{ route('testimonials.store') }}" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    @csrf

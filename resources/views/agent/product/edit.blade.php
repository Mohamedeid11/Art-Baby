                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card-box">
                                ...
                                <form method="POST" action="{{ route('agent-products.update', $product['id']) }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="agent" name="agent" required class="form-control" disabled>
                                            @foreach ($agents as $agent)
                                                <option {{ $agent['id'] == $product['agent_id'] ? 'selected' : '' }}
                                                    value="{{ $agent['id'] }}">{{ $agent['name'] }}</option>
                                            @endforeach
                                        </select>
                                        <input type="hidden" name="agent" value="{{ auth('agent')->user()->id }}" />
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="color" name="color[]" required class="form-control" multiple>
                                            ...
                                            @foreach ($colors as $color)
                                                <option value="{{ $color['id'] }}"
                                                    {{ in_array($color['id'] , $product->color()->pluck('color_id')->toArray()) ? 'selected' : '' }}>

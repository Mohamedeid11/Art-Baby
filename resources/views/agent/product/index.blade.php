                                ...
                                <table class="table table-striped" id="custom_tbl_dt">
                                    ...
                                    @if(count($products) > 0)
                                        ...
                                        <tr class="gradeX {{ $product['id'] }}">
                                            ...
                                            <td>
                                                <a href="{{ route('agent-products.show', $product['id']) }}" class="on-default"><i class="fa fa-eye"></i></a>
                                            </td>
                                            <td>
                                                <a href="{{ route('agent-products.comments', $product['id']) }}" class="on-default"><i class="fa fa-comment-o"></i></a>
                                            </td>
                                            <td>
                                                <a href="{{ route('agent-products.edit', $product['id']) }}" class="on-default"><i class="fa fa-pencil"></i></a>
                                            </td>
                                            <td class="actions">
                ...
                buttons: {
                    ...
                    main: {
                        ...
                        callback: function () {
                            ...
                            deleteForm.attr('action', "agent-products/" + id);
                            deleteForm.submit();
                        }
                    }
                }
        ...
        body.on('change', '.off', function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('agent-products.switch') }}",
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: id,
                            display: 0

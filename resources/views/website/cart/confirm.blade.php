                            ...
                            <div class="row align-items-center justify-content-center">
                                ...
                                <div class="col-12 col-md-7">
                                    <div class="h-100 text-center">
                                        ...
                                        <div class="">
                                            <span
                                                class="main_bold">{{ mb_strimwidth( getProduct($item['product_id'])['name_' . app()->getLocale()], 0, 20, "...") }}</span>
                                            <br>

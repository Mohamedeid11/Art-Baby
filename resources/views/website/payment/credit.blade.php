...
<html>
    ...
    if ($amount == "0") {
        ...
        $ch = curl_init();
        // $orderID = mt_rand();
        curl_setopt($ch, CURLOPT_URL, 'https://credimax.gateway.mastercard.com/api/rest/version/52/merchant/E17350950/session');
        ...
        curl_setopt($ch, CURLOPT_POSTFIELDS,'{
            ...
            "interaction": {
                "operation": "PURCHASE",
                "returnUrl": "https://artbabybh.com/payment/success?orderID=' . $orderID  . '&clientID='. $client_id .'"
                }
            }'
        );
        ...
        mysqli_query($con, "INSERT INTO payment (client_id,order_id,operation_order_id,payment_id,result_indicator,value,result,payment_type,date)
